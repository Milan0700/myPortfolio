...
<x-layout :title="$resume->basics->name . 'Resume'">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex flex-wrap gap-6 text-slate-200 mb-8">
                            @if ($resume->basics->email)
                                <x-contact-item :href="'mailto:' . $resume->basics->email" :text="$resume->basics->email">
                                    <x-slot:icon>
                            ...
                            @if ($resume->basics->location->city && $resume->basics->location->region)
                                <x-contact-item :text="$resume->basics->location->city . ', ' . $resume->basics->location->region">
                                    <x-slot:icon>
                                        <svg class="w-4 h-4 stroke-2" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="pt-16 grid gap-y-16">
        ...
        @if (!empty($resume->skills))
            <section>
                <x-section-header title="Skills & Expertise" icon-color="from-purple-500 to-pink-600">
                    <x-slot:icon>
        ...
        @if (!empty($resume->projects))
            <section>
                <x-section-header title="Featured Projects" icon-color="from-orange-500 to-red-600">
                    <x-slot:icon>
                        <svg class="w-6 h-6 text-white stroke-2" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="space-y-6">
                    @foreach ($resume->projects as $project)
                        <x-section-card>
                            ...
                            <x-highlight-list :highlights="$project->highlights" bullet-color="from-orange-500 to-red-500" />
